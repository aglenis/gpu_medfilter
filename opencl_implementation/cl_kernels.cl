...
void bubbleSort(unsigned char v[],int size)
{
 ...
 // __constant int WINDOW_SIZE=(int)sqrt((float)ARRAY_SIZE_ARG);
      ...
      __kernel 
void MedianFilter2D( __global unsigned char *input,__global unsigned char* output,int widthImage, int heightImage)
{    
...
__kernel
void MedianFilter2D_histogram( __global unsigned char *input,__global unsigned char* output,int widthImage, int heightImage)
{
    int filter_offset=WINDOW_SIZE/2;
//y and x are oposite the cuda programming model
    unsigned int y = get_global_id(0);
...
__kernel
void MedianFilter2D_partial (__global unsigned char *input,__global unsigned char* output,int widthImage, int heightImage)
{
    int filter_offset=WINDOW_SIZE/2;
//y and x are oposite the cuda programming model
    unsigned int y = get_global_id(0);
...
__kernel
void MedianFilter2D_forgetful(__global unsigned char *input,__global unsigned char* output,int widthImage, int heightImage)
{
    int filter_offset=WINDOW_SIZE/2;
//y and x are oposite the cuda programming model
    unsigned int y = get_global_id(0);
...
__kernel
void histogram2d(__global unsigned char * array,__global unsigned char * out_array,__global unsigned int * histogram_array,int widthImage,int heightImage)
{
